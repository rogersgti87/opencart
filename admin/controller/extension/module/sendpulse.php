...
class ControllerExtensionModuleSendpulse extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['module_sendpulse_sender_default'])) {			
			$data['module_sendpulse_sender_default'] = $this->request->post['module_sendpulse_sender_default'];			
		} else {
			$data['module_sendpulse_sender_default'] = $this->config->get('module_sendpulse_sender_default');
		}
		...
		if($id != '' && $secret != '') {
			$data['senders'] = $this->model_extension_module_sendpulse->listSenders($id, $secret);
			if(!$data['senders']) $this->error['warning'] = $this->language->get('error_connect');
		}
		else $data['senders'] = false;
        ...
        if (isset($this->request->post['module_sendpulse_nascimento'])) {
            $data['module_sendpulse_nascimento'] = $this->request->post['module_sendpulse_nascimento'];
        } else {
            $data['module_sendpulse_nascimento'] = $this->config->get('module_sendpulse_nascimento');
        }

        if (isset($this->request->post['module_sendpulse_celular'])) {
            $data['module_sendpulse_celular'] = $this->request->post['module_sendpulse_celular'];
        } else {
            $data['module_sendpulse_celular'] = $this->config->get('module_sendpulse_celular');
        }

        if (isset($this->request->post['module_sendpulse_sexo'])) {
            $data['module_sendpulse_sexo'] = $this->request->post['module_sendpulse_sexo'];
        } else {
            $data['module_sendpulse_sexo'] = $this->config->get('module_sendpulse_sexo');
        }
