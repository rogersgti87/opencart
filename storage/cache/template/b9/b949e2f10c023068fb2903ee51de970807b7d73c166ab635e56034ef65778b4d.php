...
class __TwigTemplate_9a44f83e5cc1d6611b770097bc9848a5f51cf952cb935e7617b11a6c52e7b1b4 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\tvar startTime = moment(Date()).add(30, 'minutes').format('HH:mm');\t
...
\t\t\t\tif(currentDateTime.getDate() == moment(ct).format('DD') && currentDateTime.getHours() >= 23 && currentDateTime.getMinutes() <= 30){
\t\t\t\t\tthis.setOptions({
\t\t\t\t\t  //allowTimes:['05:00']\t\t\t\t\t\t
\t\t\t\t\t  minTime:'23:00',
\t\t\t\t\t  //maxTime:'23:00',
