...
class __TwigTemplate_d108039e73a486cadb2ddf8d10df03067c08e86a9d7328367cd22fec1086b6b1 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\tif(currentDateTime.getHours() <= 21 && currentDateTime.getMinutes() >= 59){
\t\t\t  \t\tthis.setOptions({
\t\t\t\t\t\t//allowTimes:['05:00']
\t\t\t\t\t\tminTime:'00:00',
\t\t\t\t\t\tstep: 240,
