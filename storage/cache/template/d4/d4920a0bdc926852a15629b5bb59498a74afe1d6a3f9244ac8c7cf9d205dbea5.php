...
class __TwigTemplate_5e84c14e75a77e734ecb0df205f87ee29574672be1eeb8fa53c1d30bf80b00e3 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    \t\t\t<label class=\"col-sm-2 control-label\" for=\"input-senders-default\">Remetente Padrão</label>
      ...
      \t\t\t\t<option value=\"\">";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["sender"]) {
                ...
                echo ",'email':";
                echo twig_get_attribute($this->env, $this->source, $context["sender"], "email", [], "any", false, false, false, 111);
                echo "}\" ";
                if ((["name" => twig_get_attribute($this->env, $this->source, $context["sender"], "name", [], "any", false, false, false, 111), "email" => twig_get_attribute($this->env, $this->source, $context["sender"], "email", [], "any", false, false, false, 111)] == ($context["module_sendpulse_sender_default"] ?? null))) {
                    echo " selected ";
                }
                echo ">";
                echo json_encode(["name" => twig_get_attribute($this->env, $this->source, $context["sender"], "name", [], "any", false, false, false, 111)]);
                echo "</option>
      \t\t\t\t";
            }
            $_parent = $context['_parent'];
...
";
    ...
    {
        return array (  521 => 217,  510 => 209,  483 => 185,  475 => 180,  469 => 176,  460 => 169,  449 => 167,  445 => 166,  441 => 165,  435 => 162,  428 => 158,  419 => 152,  415 => 150,  413 => 149,  404 => 142,  399 => 140,  394 => 139,  389 => 137,  384 => 136,  382 => 135,  376 => 132,  373 => 131,  367 => 127,  352 => 125,  348 => 124,  344 => 123,  338 => 120,  335 => 119,  333 => 118,  330 => 117,  324 => 113,  307 => 111,  303 => 110,  299 => 109,  293 => 105,  291 => 104,  284 => 99,  279 => 97,  274 => 96,  269 => 94,  264 => 93,  262 => 92,  256 => 89,  249 => 84,  234 => 82,  230 => 81,  219 => 72,  204 => 70,  200 => 69,  189 => 60,  174 => 58,  170 => 57,  159 => 48,  153 => 46,  151 => 45,  145 => 44,  140 => 42,  135 => 39,  129 => 37,  127 => 36,  121 => 35,  116 => 33,  111 => 31,  105 => 28,  101 => 26,  93 => 22,  91 => 21,  84 => 18,  82 => 17,  76 => 13,  65 => 11,  61 => 10,  56 => 8,  50 => 7,  46 => 6,  37 => 1,);
    }
