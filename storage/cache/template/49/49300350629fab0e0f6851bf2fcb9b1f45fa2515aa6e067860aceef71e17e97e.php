...
class __TwigTemplate_ccabb0181f688aaee252acf2cffa3620419d166b0fdfaaeb17a03d1a89995b80 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    \t\t\t<label class=\"col-sm-2 control-label\" for=\"input-senders-default\">Remetente Padrão</label>
      ...
      \t\t\t\t<option value=\"\">";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["sender"]) {
                ...
                echo "\" ";
                if ((json_encode(["name" => twig_get_attribute($this->env, $this->source, $context["sender"], "name", [], "any", false, false, false, 111), "email" => twig_get_attribute($this->env, $this->source, $context["sender"], "email", [], "any", false, false, false, 111)]) == ($context["module_sendpulse_sender_default"] ?? null))) {
                    echo " selected ";
                }
                echo ">";
