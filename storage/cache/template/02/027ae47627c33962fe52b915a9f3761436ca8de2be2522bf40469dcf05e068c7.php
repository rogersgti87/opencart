...
class __TwigTemplate_e9b7c6a4feda818d385afad4bad3e3d2b82d84dde1b178c47597b59e528bc7ee extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t  var newDate = moment(Date()).add(4, 'hours').format('dd');
\t\t  console.log(newDate);
\t\t
