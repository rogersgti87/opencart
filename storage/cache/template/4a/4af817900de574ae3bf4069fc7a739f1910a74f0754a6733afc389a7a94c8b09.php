...
class __TwigTemplate_787def016ec3fec7a761ff02b7fcde936f8f54bb1cb4f7285574b5ada9e33c3d extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    \t\t\t<label class=\"col-sm-2 control-label\" for=\"input-senders-default\">Remetente Padrão</label>
      ...
      \t\t\t\t<option value=\"\">";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["sender"]) {
                ...
                echo ">";
                echo json_encode(twig_get_attribute($this->env, $this->source, $context["sender"], "name", [], "any", false, false, false, 111));
                echo "</option>
      \t\t\t\t";
            }
            $_parent = $context['_parent'];
