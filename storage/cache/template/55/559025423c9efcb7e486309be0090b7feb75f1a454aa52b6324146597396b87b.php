...
class __TwigTemplate_2c4db632b51393c2a058f0f44ebd2625c4cc0bcebdf24dccb4a628a8465a1c3d extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t  var newDate = moment(Date()).add(4, 'hours').format('DD/MM/YYY');
\t\t  console.log(newDate);
\t\t
