...
class __TwigTemplate_5fee53bbedcac5dcca7cb32ac462682d5579452d2d27740053122ac46342fccf extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t  var newDate = moment(Date()).add(4, 'hours').format('d');
\t\t  console.log(newDate);
\t\t
