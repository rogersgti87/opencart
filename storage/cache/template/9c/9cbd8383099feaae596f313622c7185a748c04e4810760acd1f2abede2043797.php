...
class __TwigTemplate_8b8d99b369bc46c0c7503e1fb6139292290226f2a8b1d27d804e06808cd90a05 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t  var newDate = moment(Date()).add(4, 'hours').format('DD/MM/YYYY');
\t\t  console.log(newDate);
\t\t
