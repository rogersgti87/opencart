...
class __TwigTemplate_5c33146f52e75e3232ddad49be89562f9c1344aa401325f4c26ddcddb0417126 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    \t\t\t<label class=\"col-sm-2 control-label\" for=\"input-senders-default\">Remetente Padrão</label>
      ...
      \t\t\t\t<option value=\"\">";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["sender"]) {
                // line 111
                echo "      \t\t\t\t<option value=\"";
                echo json_encode(["name" => twig_get_attribute($this->env, $this->source, $context["sender"], "name", [], "any", false, false, false, 111), "email" => twig_get_attribute($this->env, $this->source, $context["sender"], "email", [], "any", false, false, false, 111)]);
                echo "\" ";
