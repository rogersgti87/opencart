...
class __TwigTemplate_0c36075ee902a4716768b8c713e8cd4b2d3606a92e2fb64ec6cb8f44f8ecb3cb extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t  <div class=\"form-group required\">
            <label class=\"col-sm-2 control-label\" for=\"input-campaign-name\">Data de envio ";
        // line 39
        echo twig_date_converter($this->env, "Y-m-d H:i:s");
        echo "</label>
            <div class=\"col-sm-10\">
...
\t\tvar newDate = (\"0\" + dt.getDate()).slice(-2) + \"/\" + (\"0\"+(dt.getMonth()+1)).slice(-2) + \"/\" +
\t\t\t\t\t   dt.getFullYear() + \" \" + (\"0\" + dt.getHours()).slice(-2) + \":\" + (\"00\");\t\t\t
\t\t\t\t\t\t 
\t\t//console.log(newDate);\t\t
...
\t\t\tlanguage: 'pt-br',
\t\t\tminuteStepping: 30,
\t\t\tdefaultDate: moment(dt).add(1, 'hours').format('DD/MM/YYYY HH:mm:ss'),
...
";
    ...
    {
        return array (  318 => 200,  240 => 125,  175 => 63,  168 => 61,  163 => 58,  157 => 54,  142 => 52,  138 => 51,  134 => 50,  128 => 46,  126 => 45,  117 => 39,  109 => 34,  104 => 32,  88 => 19,  80 => 13,  69 => 11,  65 => 10,  60 => 8,  54 => 7,  46 => 6,  37 => 1,);
    }
