...
class __TwigTemplate_ad56900442e3543acd5a501d53df799e833e4e3debaea946423c87049c1abe29 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    \t\t\t<label class=\"col-sm-2 control-label\" for=\"input-senders-default\">Remetente Padrão</label>
      ...
      \t\t\t\t<option value=\"\">";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["sender"]) {
                ...
                echo "\" ";
                if ((((twig_get_attribute($this->env, $this->source, $context["sender"], "name", [], "any", false, false, false, 111) . ",") . twig_get_attribute($this->env, $this->source, $context["sender"], "email", [], "any", false, false, false, 111)) == ($context["module_sendpulse_sender_default"] ?? null))) {
                    echo " selected ";
                }
                echo ">";
