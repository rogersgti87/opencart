...
class __TwigTemplate_b23f3bcfbf2f0f4fe99be29c7a2b61b1ef7e85a757d64094e8ae4f070182c132 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\tvar newDate = moment(Date()).add(2, 'hours').format('HH:mm');
