...
class __TwigTemplate_4f1242c461c092f5262f35bce17728b4c27edbe0c071535fcf70e171ae76035f extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\tif(currentDateTime.getDate() == moment(ct).format('DD') && currentDateTime.getHours() >= 23 && currentDateTime.getMinutes() <= 10){
\t\t\t\t\tthis.setOptions({
\t\t\t\t\t  //allowTimes:['05:00']\t\t\t\t\t\t
\t\t\t\t\t  minTime:'23:30',
\t\t\t\t\t  //maxTime:'23:00',
