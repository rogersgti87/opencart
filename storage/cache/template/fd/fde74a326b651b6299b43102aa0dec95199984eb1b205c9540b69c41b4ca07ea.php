...
class __TwigTemplate_beffd833d44bafc9c0b4884880724ceec6e7a1a17fa4387378954bd0b7d578fd extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\tvar startTime = moment(Date()).add(1, 'hours').format('HH:mm');\t
...
\t\t\t\tvar currentDateTime = new Date();
\t\t\t\tif(currentDateTime.getDate() == moment(ct).format('DD') && currentDateTime.getHours() >= 23 && currentDateTime.getMinutes() <= 59){
\t\t\t\t\tthis.setOptions({
\t\t\t\t\t  //allowTimes:['05:00']\t\t\t\t\t\t
\t\t\t\t\t  minTime:'23:00',
\t\t\t\t\t  maxTime:'23:00',
