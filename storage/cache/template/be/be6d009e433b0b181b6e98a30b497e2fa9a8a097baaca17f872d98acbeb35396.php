...
class __TwigTemplate_d931e2e0ce5282e51e5f7e735b2b94aa18b8e8af7fb20f7d66aa826b332a7401 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t 
\t\t//console.log(newDate);
\t\tconsole.log(moment(dt).add(4, 'hours').format('DD/MM/YYYY'));
