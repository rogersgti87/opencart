...
class __TwigTemplate_d6dd3c2f14b6c56af6a5839da33467db2105df9cf1e81bd4c7a245648c7a391c extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t//currentDateTime.getHours() <= 19
\t\t\tvar newDate = moment(Date()).add(1, 'hours').format('HH:mm');\t\t\t\t\t\t

\t\t\t\$('button.somebutton').on('click', function () {
\t\t\t\tvar d = \$('#input-campaign-date').datetimepicker('getValue');
\t\t\t\tconsole.log(d.getDate());

\t\t\t\tif(currentDateTime.getDate() == d.getDate() && currentDateTime.getHours() >= 22 && currentDateTime.getMinutes() <= 59){
\t\t\t\t\tthis.setOptions({
\t\t\t\t\t  //allowTimes:['05:00']\t\t\t\t\t\t
\t\t\t\t\t  minTime:'23:00',
\t\t\t\t\t  step: 240,
...
\t\t\t\tconsole.log(moment(ct).format('DD'));
\t\t\t\tvar currentDateTime = new Date();
\t\t\t\tif(currentDateTime.getDate() == moment(ct).format('DD') && currentDateTime.getHours() >= 22 && currentDateTime.getMinutes() <= 59){
\t\t\t\t\tthis.setOptions({
\t\t\t\t\t  //allowTimes:['05:00']\t\t\t\t\t\t
\t\t\t\t\t  minTime:'23:00',
\t\t\t\t\t  step: 240,
...
";
    ...
    {
        return array (  360 => 245,  282 => 170,  172 => 63,  165 => 61,  160 => 58,  154 => 54,  139 => 52,  135 => 51,  131 => 50,  125 => 46,  123 => 45,  109 => 34,  104 => 32,  88 => 19,  80 => 13,  69 => 11,  65 => 10,  60 => 8,  54 => 7,  46 => 6,  37 => 1,);
    }
