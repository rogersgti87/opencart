...
class __TwigTemplate_7922164ac93670f43e51ff0119088ca506bd53bfa0c1ee906b2191dbb183fefc extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t  \t\tthis.setOptions({allowTimes:['04:00']});
\t\t\t\t}else{
\t\t\t\t\tthis.setOptions({allowTimes:['00:00']});
\t\t\t\t}
\t\t\t}else
\t\t\t  this.setOptions({
\t\t\t\t//minTime:'00:00',
