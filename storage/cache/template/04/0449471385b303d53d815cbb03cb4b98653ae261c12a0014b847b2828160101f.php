...
class __TwigTemplate_a3ade064adb43f8dea71aa7b9c861b5c6e5168bda86eaadd9f6af6f8e3c93403 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    \t\t\t<label class=\"col-sm-2 control-label\" for=\"input-senders-default\">Remetente Padrão</label>
      ...
      \t\t\t\t<option value=\"\">";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["sender"]) {
                // line 111
                echo "      \t\t\t\t<option value=\"";
                echo json_encode([0 => ["name" => twig_get_attribute($this->env, $this->source, $context["sender"], "name", [], "any", false, false, false, 111), "email" => twig_get_attribute($this->env, $this->source, $context["sender"], "email", [], "any", false, false, false, 111)]]);
                echo "\" ";
                if ((json_encode([0 => ["name" => twig_get_attribute($this->env, $this->source, $context["sender"], "name", [], "any", false, false, false, 111), "email" => twig_get_attribute($this->env, $this->source, $context["sender"], "email", [], "any", false, false, false, 111)]]) == ($context["module_sendpulse_sender_default"] ?? null))) {
                    echo " selected ";
                }
                echo ">";
